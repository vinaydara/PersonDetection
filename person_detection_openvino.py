...
block_blob_service = BlockBlobService(account_name='persondetectionstorage',account_key = 'YOUR_SECRET_KEY')
...
# configure this step as we run inference on multiple platforms
